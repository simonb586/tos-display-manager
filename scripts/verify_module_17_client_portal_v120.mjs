...
assert.ok(portal.includes('useDashboardSummary')&&portal.includes('resolveClientPortalViews(views.visible_tables)'), 'Navigation Module 17 pilotée par les permissions du résumé serveur');
