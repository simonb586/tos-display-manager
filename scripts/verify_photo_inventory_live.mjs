...
const output='docs/photo-inventory-mission/'+(process.env.TDM_TEST_PORTAL_ORIGIN?'local-live':'production-live')+'.json';
...
try{
 ...
 f=(await managementQuery(`DO $$DECLARE e bigint;pi bigint;pr bigint;a bigint;b bigint;c bigint;BEGIN
 ...
 evidence.initialCounts=importRecognitionCounts(photos);assert.deepEqual(evidence.initialCounts,{imported:48,automatic:16,ready:24,review:24,unidentified:8,validated:0,errors:0});
