...
for(const marker of ['getTerrainSyncTimeline','listFinalCommunications','Promise.allSettled'])assert.ok(module14Service.includes(marker),marker);
for(const marker of ['operationalKpis.terrain','operationalKpis.reports','Diagnostic terrain','Rapports finaux'])assert.ok(dashboard.includes(marker),marker);
