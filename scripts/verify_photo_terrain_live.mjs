...
const file=`docs/photo-inventory-mission/terrain-${label}.json`;
...
try{
 ...
 if(f){
  ...
  delete from enjeux_terrain where support_id='${support}';delete from inspections_terrain where support_id='${support}';delete from support_photos where support_id='${support}';delete from tdm_private.display_baselines where support_id='${support}';delete from historique_des_campagnes where support_id='${support}';delete from terrain_operations where support_id='${support}';delete from support_photos where support_id='${support}';delete from infrastructures where id=${f.supportId} and support_id='${support}';delete from campagne_visuels_formats where id=${f.visualId} and nom_visuel='${support}';delete from edt_phases where id in (${f.phaseId},${f.phase2Id});delete from suivi_des_edt where id in (${f.edtId},${f.edt2Id});END $$;`);
