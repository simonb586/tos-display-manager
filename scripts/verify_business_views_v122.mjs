...
for(const marker of['UnifiedDataGrid','filters={filters}','sortState={sortState}','GridPagination','Modifier la grille','Largeur','Réinitialiser la grille','Page visible','Sélection','Ensemble filtré','getAllAssignmentsBySiteAndSupport'])assert.ok(view.includes(marker),marker);
