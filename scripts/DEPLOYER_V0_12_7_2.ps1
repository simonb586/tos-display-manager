...
node scripts/installer_bloc12_7_2.mjs
...
git add .
git commit -m "Version 0.12.7.2 - Ambiguïté SQL terrain corrigée"
...
Write-Host ""
Write-Host "✅ v0.12.7.2 compilée et poussée vers GitHub." -ForegroundColor Green
