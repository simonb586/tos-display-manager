...
const photo={originalFilename:'VH-1000-12_01.jpg',capturedAt:'2026-06-01T12:00:00Z',capturedAtSource:'EXIF'};
...
check('All support EDTs and operational out-of-frame visual',()=>assert.equal(recognizeImportPhoto({...photo,capturedAt:'2026-07-01T12:00:00Z'},catalog).values.visual,80));
...
check('Visual ambiguity preserves all certain context',()=>{const r=recognizeImportPhoto(photo,{...catalog,visuals:[...catalog.visuals,{...catalog.visuals[0],id:71}]});assert.deepEqual(r.pending,['visual']);assert.equal(r.values.edt,1);});
