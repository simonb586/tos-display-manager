...
- CLIENT VIEWS : **4** vues métier autorisées, **6** entrées avec Sommaire et Exports.
- CLIENT-ADMIN VIEWS : **13** vues métier autorisées, **15** entrées avec Sommaire et Exports.
