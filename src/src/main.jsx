...
function App() {
  ...
  if (profileLoading || (session && loading)) return <div className="login"><div className="loginCard"><h1>TOS Display Manager</h1><p>Ouverture sécurisée de votre espace…</p></div></div>;
