...
export const CLIENT_PORTAL_VIEW_REGISTRY = Object.freeze([
  ...
  view({ id: 'marketing_assignments', label: 'Campagnes et visuels par site et supports', icon: Image, section: 'marketing_assignments', component: 'SiteSupportAssignmentsView', dataSource: 'siteSupportBusinessService:marketing', permissionKeys: ['Campagnes et visuels par site et supports'] }),
  view({ id: 'operational_assignments', label: 'Communications opérationnelles par site et supports', icon: ShieldCheck, section: 'operational_assignments', component: 'SiteSupportAssignmentsView', dataSource: 'siteSupportBusinessService:operational', permissionKeys: ['Communications opérationnelles par site et supports'] }),
  ...
  view({ id: 'photos', label: 'Photos et inventaire', icon: Camera, section: 'photos', component: 'PhotoInventoryCenter', dataSource: 'client_portal_list_v120:photos', permissionKeys: ['Photos et inventaire'], aliases: ['Photos'] }),
