...
function CompactActions({ primary, children }) {
  return <div className="automation-compact-actions">{primary}<details><summary aria-label="Autres actions"><MoreHorizontal/></summary><div>{children}</div></details></div>;
}
