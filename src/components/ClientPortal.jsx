...
import {listSupportPhotosForValidation} from '../services/photoInventoryService';
import PhotoInventoryCenter from './PhotoInventoryCenter';
import SiteSupportAssignmentsView from './SiteSupportAssignmentsView';
import {getAllAssignmentsBySiteAndSupport} from '../services/siteSupportBusinessService';
...
function ClientPortalSession({profile={},onLogout,preview=null,onClose}){
 ...
 const load=useCallback(async(view,page=1,pageSize=25,filters={})=>{
  if(!view||['photos','marketing_assignments','operational_assignments'].includes(view.id))return;
