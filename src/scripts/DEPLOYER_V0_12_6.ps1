...
node scripts/installer_bloc12_6.mjs
...
git add .
git commit -m "Version 0.12.6 - Synchronisation terrain atomique"
...
Write-Host ""
Write-Host "✅ v0.12.6 compilée et poussée vers GitHub." -ForegroundColor Green
